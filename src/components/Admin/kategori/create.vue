...
export default {
  ...
  methods: {
    async submitForm() {
      ...
      try {
        const res = await axios.post('/kategoris', this.form)
        ...
        console.error('Error creating kategori:', err.response?.data || err)
        ...
        if (err.response?.data?.errors) {
          ...
          this.error = err.response?.data?.message || err.message || 'Gagal membuat kategori'
        }
      } finally {
        this.submitting = false
      }
